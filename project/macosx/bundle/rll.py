...
# List dylib dependencies for binaries/dylibs passed as arguments, and those dylibs' dependencies, and those dylibs' dependencies...
# Modified from https://github.com/mixxxdj/mixxx/blob/master/build/osx/otool.py, which is licensed under the GPL v2.
