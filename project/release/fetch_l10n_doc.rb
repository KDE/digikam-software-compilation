...
i18nlangs.each_line do |lang|
    ...
    if (lang != nil && lang != "")
        ...
        for part in ['color-management', 'credits-annex', 'editor-color', 'editor-decorate', 'editor-enhance', 'editor-filters', 'editor-transform', 'file-formats', 'ie-menu', 'index', 'menu-descriptions', 'photo-editing', 'sidebar', 'tool-acquireimages']
...
i18nlangs.each_line do |lang|
    ...
    if (lang != nil && lang != "")
        ...
        for part in ['effectimages' 'geolocation' 'index' 'printwizard' 'renameimages' 'slideshow' 'colorimages' 'filterimages' 'imagesgallery' 'jpeglossless' 'rawconverter' 'resizeimages' 'convertimages' 'flickrexport' 'imageviewer' 'metadataeditor' 'recompressimages' 'sendimages']
